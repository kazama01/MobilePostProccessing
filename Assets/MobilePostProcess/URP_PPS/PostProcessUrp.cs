...
public class PostProcessUrp : ScriptableRendererFeature
{
    ...
    {
        ppsUrpPass = new PostProcessUrpPass(
            settings.Event,
            ...
            settings.Bloom,
            settings.BloomColor,
            settings.BloomAmount,
            settings.BloomDiffuse,
            settings.BloomThreshold,
            settings.BloomSoftness,
            settings.LUT,
            settings.LutAmount,
            settings.SourceLut,
            settings.ImageFiltering,
            settings.Color,
            settings.Contrast,
            settings.Saturation,
            settings.Brightness,
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        // Remove the Setup call since we'll handle the camera target in Execute
