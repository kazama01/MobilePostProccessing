//
// Updated for Unity "6" compatibility mode (no Render Graph).
//
...
public class PostProcessUrpPass : ScriptableRenderPass
{
    ...
    public PostProcessUrpPass(RenderPassEvent renderPassEvent,
        Material material,
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        // Get the camera color target from renderingData
        RTHandle cameraColorTarget = renderingData.cameraData.renderer.cameraColorTargetHandle;
        
        cmd.GetTemporaryRT(tempCopyString, opaqueDesc, FilterMode.Bilinear);
        // Use the RTHandle instead of source
        cmd.CopyTexture(cameraColorTarget, tempCopy);
        ...
        // Use the RTHandle for the final blit
        cmd.Blit(tempCopy, cameraColorTarget, material, 1);
